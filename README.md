...
* **Sistema de Préstamos y Devoluciones:** Permite asignar libros a usuarios (y valida previamente que no se encuentren prestados) actualizando automáticamente el estado del libro.
